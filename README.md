...
The Astro CUBE CSS Boilerplate is a simple, modern, web platform native starting point with sensible defaults. You get the advantages of modern CSS, with the aid of utility classes. 

Uses:
- [Astro](https://astro.build/), a minimal framework for building SSG and SSR sites
